...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;ipv6_prefix_length</samp>](## "fabric_ip_addressing.p2p_uplinks.ipv6_prefix_length") | Integer |  | `127` | Min: 1<br>Max: 127 | IPv6 prefix length used for L3 point-to-point uplinks. |
...
=== "YAML"
    ...
    fabric_ip_addressing:
      ...
      p2p_uplinks:
        ...
        ipv6_prefix_length: <int; 1-127; default=127>
